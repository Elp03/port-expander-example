...
async fn main(_spawner: Spawner) -> ! {
    ...
    loop {
        ...
        pin1_5.set_high().expect("Pin 1.1 failed");
        Timer::after_millis(1).await;
        pin1_4.set_high().expect("Pin 1.2 failed");
        pin1_3.set_high().expect("Pin 1.3 failed");
        pin1_2.set_high().expect("Pin 1.4 failed");
        pin1_1.set_high().expect("Pin 1.5 failed");
        // pin1_5.set_high()unwrap();
        defmt::info!("Blink");
        ...
        pin1_5.set_low().expect("Pin 1.1 failed");
        Timer::after_millis(1).await;
        pin1_4.set_low().expect("Pin 1.2 failed");
        pin1_3.set_low().expect("Pin 1.3 failed");
        pin1_2.set_low().expect("Pin 1.4 failed");
        pin1_1.set_low().expect("Pin 1.5 failed");
        // pin1_5.set_low().nwrap();
